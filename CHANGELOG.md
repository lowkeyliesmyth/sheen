...
- **ameba**: Upgrade ameba to 1.7-dev and fix new linter violations

### Build System

- **crystal**: update min crystal version to new 1.21.0 with executioncontexts

### CI

- **gha-spec**: run spec tests on push to master as well
- **gha**: update crystal version in ci workflows to 1.21.0
- **gha-ameba**: build ameba in ci for >= 1.7.0
